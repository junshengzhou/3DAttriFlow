...
from models.PC.utils import Conv1d, PointNet_FP_Module, PointNet_SA_Module, Transformer
...
class PointsEncoder_label(nn.Module):
    def __init__(self, out_dim=512):
        ...
        self.transformer_start_1 = Transformer(128+16, dim=64)
        self.sa_module_2 = PointNet_SA_Module(128, 32, 0.4, 128+16, [128, 128, 256], group_all=False)
...
class PointsEncoder_pointwise(nn.Module):
    def __init__(self):
        ...
        self.fp_module_2 = PointNet_FP_Module(256, [256, 128+16], use_points1=True, in_channel_points1=128+16)
        self.transformer_end_1 = Transformer(128+16, dim=64)
        self.fp_module_1 = PointNet_FP_Module(128+16, [128, 128, 128], use_points1=True, in_channel_points1=6)

        self.conv_DownFeatureStep1 = Conv1d(128+16, 128+16, if_bn=True, activation_fn=torch.relu)
    ...
    def forward(self, point_cloud, label):
        ...
        return l0_points, l3_points.squeeze(2)
